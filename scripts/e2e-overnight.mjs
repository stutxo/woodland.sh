...
const EXPECTED_WORLD = Object.freeze({
  ...
  axeRecipes: Object.freeze([
    Object.freeze({ axe: 'wooden', requiredLevel: 1, logCost: 1, stoneCost: 0, ironOreCost: 0 }),
    Object.freeze({ axe: 'stone', requiredLevel: 5, logCost: 2, stoneCost: 2, ironOreCost: 0 }),
    Object.freeze({ axe: 'iron', requiredLevel: 15, logCost: 5, stoneCost: 0, ironOreCost: 2 }),
  ]),
...
function manifestSummary(manifest) {
  ...
  return {
    ...
    rates: {
      ...
      maxLogDropBasisPoints: manifest.maxLogDropBasisPoints,
      stoneDropBasisPoints: manifest.stoneDropBasisPoints,
      ironOreDropBasisPoints: manifest.ironOreDropBasisPoints,
      ironOreUnlockLevel: manifest.ironOreUnlockLevel,
      luckWindowBasisPoints: manifest.luckWindowBasisPoints,
      initialLuckCredit: manifest.initialLuckCredit,
      axeRecipes: manifest.axeRecipes,
    },
    ...
    stoneReservePerTree: manifest.stoneReservePerTree,
    ironOreReservePerTree: manifest.ironOreReservePerTree,
